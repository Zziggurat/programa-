		...
		simulacion: () => {
			...
			return {
				...
				fisica: !fisica ? undefined : {
					...
					contactos: [...fisica.contactos.values()], transformadores: [...fisica.red.transformadores.values()],
					motores: [...fisica.motores.values()], variadores: [...fisica.variadores.values()],
					trifasicos: [...fisica.trifasicos.values()], diagnosticoIndustrial: r?.diagnosticoIndustrial,
