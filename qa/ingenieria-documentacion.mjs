...
try{
	...
	const bom=await descargarAccion('bom');comprobar('BOM CSV explica la variante declarada sin inventar precios',/^\uFEFFCantidad;Tipo;Descripción;Fabricante;Referencia;Perfil;Modelo físico;Variante declarada;Designaciones/m.test(bom.text)&&/Tipo:/.test(bom.text)&&!/Precio|Costo/.test(bom.text));
