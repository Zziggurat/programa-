...
- `qa/localidad-densa-m6.mjs`: **5/5** en 36,6 s sobre el mismo código, 0 errores JS. En 61 conexiones, editar `w18` conservó exactamente las otras 60 rutas; reapertura conservó 59 planes, el ID de documento y un snapshot entre dos guardados próximos. Medición de esta ejecución: 299 972 bytes JSON, 2257 ms hasta planificar 59 cables y 365 ms de espera de guardado. No es un p95 ni prueba de cuota IndexedDB.
