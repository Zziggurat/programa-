...
|---|---|---|
| M0 · preparación | EN_CURSO | R1 sintético 30/100 en SwiftShader. Reconciliación de mallas 98→10, rejilla y prefiltrado de sólidos candidatos conservan 5/5 hashes exactos; mediciones Node pareadas exploratorias del último corte bajaron 6153→5010 ms y 6241→4805 ms, sin representar p95. El focal de navegador previo registró drag host 24,43 s (n=1); falta repetirlo sobre el corte actual y medir en GPU física. R1 NO ACEPTADO. |
...
| M2 · esquema | EN_CURSO | Vista opt-in y una red; el contrato V2 distingue conexión eléctrica con ruta física pendiente de cable legacy. Gesto visible de conectar bornes reales, incluso entre hojas, con confirmación/Undo/reapertura (QA 19/19); cruces puntuales interiores y en T sin unión muestran hueco en SVG/PDF/DXF y solo bornes reales generan nudo, con pruebas focales. Faltan solapes colineales independientes, renumeración y aceptación multihoja completa; M2 NO aceptado. |
| M3 · documentación | EN_CURSO | DOC-01 cubre focalmente HTML, dossier y esquema PDF, esquema SVG/DXF, placa DXF, rótulos PDF, Ingeniería V7 (JSON/HTML/4 CSV) y exportación de Diseño V9 con procedencia confirmada o efímera explícita. QA de navegador 16/16, 0 JS. Falta aceptación visual humana; DOC-02 requiere paquete coherente y DOC-03…09 no están aceptados. M3 NO aceptado. |
...
2. M2: completar renumeración y flujos multihoja; preservar el hueco gráfico de cruces sin unión y la conexión visible de bornes con ruta pendiente, sin materializar metros automáticamente.
3. M3: revisar visualmente los documentos producidos, cerrar el paquete coherente DOC-02 y tratar DOC-03…09 por separado; no confundir cobertura focal de procedencia con aceptación del hito.
