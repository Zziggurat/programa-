...
| M2 · esquema | EN_CURSO | Vista opt-in y una red; el contrato V2 distingue conexión eléctrica con ruta física pendiente de cable legacy. Ya existe gesto visible de conectar bornes reales, incluso entre hojas, con confirmación, cancelación, Undo/Redo y reapertura; QA focal 19/19 sin errores JS. Ruteo, física, 3D, canaletas, Ingeniería y resumen no inventan metraje. Faltan cruce no conectado, renumeración y aceptación multihoja completa; M2 NO aceptado. |
...
2. M2: completar el cruce no conectado, la renumeración y los flujos multihoja; preservar la conexión visible de bornes con ruta pendiente y no materializar metros automáticamente.
