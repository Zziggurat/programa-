...
export function criteriosV9():RevisionCriteriosTecnicos{return publicarRevision({...base('criterios-v9','Criterios sintéticos V9'),tipo:'CRITERIOS',ambitoDeclarado:'Fixture V9',parametros:{maxVoltageDropPercent:{modo:'VALOR',valor:2},maxLossW:{modo:'VALOR',valor:25},capacidadCorte:{modo:'VALOR',valor:'Icu'},coordinarIbInIz:{modo:'VALOR',valor:true}}});}
...
export function fixtureDisenoAsistidoV9():FixtureDisenoV9{
	...
	const actual=proteccionV9('q16',16,1),q20=proteccionV9('q20',20,1),q25=proteccionV9('q25',25,2),cable=conductorV9(),tabla=tablaV9(),criterios=criteriosV9();
	proyecto.datosTecnicos={version:1,revisiones:[actual,cable,tabla,criterios],vinculos:[
