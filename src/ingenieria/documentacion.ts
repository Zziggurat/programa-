...
export function informeIngenieriaV7AHtml(i: InformeIngenieriaV7): string {
	...
	return `<!doctype html><html lang="es"><head><meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'; font-src 'none'; connect-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'"><title>${esc(i.proyecto.nombre)} — Ingeniería V7</title><style>
